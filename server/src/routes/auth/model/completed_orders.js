...
const ordersCompletedSchema = new mongoose.Schema(
  {
    order: [Object], 
    userId: String ,
    OrderedDate: String, 
...
ordersCompletedSchema.statics.build = (attrs) => {
  return new OrdersCompleted(attrs);
};

const OrdersCompleted = mongoose.model('OrdersCompleted', ordersCompletedSchema);

module.exports.OrdersCompleted = OrdersCompleted;
